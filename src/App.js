...
import background from "./images/pattern-bg.jpg"
...
function App() {
    ...
    try {
      const getInitialData = async () => {
        const res = await fetch(
          `https://geo.ipify.org/api/v2/country,city?apiKey=at_6qiFBDSF4HNzWNP96T51MuVLIDMQa&ipAddress= 117.239.245.130`
        )
  ...
  const getEnteredData = async () => {
    const res = await fetch(
      `https://geo.ipify.org/api/v2/country,city?apiKey=at_6qiFBDSF4HNzWNP96T51MuVLIDMQa&${
